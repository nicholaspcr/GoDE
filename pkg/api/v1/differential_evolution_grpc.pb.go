...
func (c *differentialEvolutionServiceClient) ListSupportedAlgorithms(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ListSupportedAlgorithmsResponse, error) {
	...
	err := c.cc.Invoke(ctx, DifferentialEvolutionService_ListSupportedAlgorithms_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *differentialEvolutionServiceClient) ListSupportedVariants(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ListSupportedVariantsResponse, error) {
	...
	err := c.cc.Invoke(ctx, DifferentialEvolutionService_ListSupportedVariants_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *differentialEvolutionServiceClient) ListSupportedProblems(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ListSupportedProblemsResponse, error) {
	...
	err := c.cc.Invoke(ctx, DifferentialEvolutionService_ListSupportedProblems_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *differentialEvolutionServiceClient) Run(ctx context.Context, in *RunRequest, opts ...grpc.CallOption) (*RunResponse, error) {
	out := new(RunResponse)
	err := c.cc.Invoke(ctx, DifferentialEvolutionService_Run_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedDifferentialEvolutionServiceServer must be embedded to have forward compatible implementations.

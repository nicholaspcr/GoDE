...
problems = ['zdt1', 'zdt2', 'zdt3', 'zdt4', 'zdt6','dtlz1', 'dtlz2', 'dtlz3', 'dtlz4', 'dtlz5', 'dtlz6',
...
for problem in problems:
    ...
    data = []
    for var in variants:
        data.append(HVData[var].sort_values())
    ...
    subs.set(
        ...
        title='Hypervolume variants performance in ' + problem,
        xlabel='Variants',
        ylabel='HyperVolume',
    )
    ...
    plt.title(
            'Hypervolume variants performance in ' + problem.upper(),
    ...
    plt.legend()
    # plt.show()
    plt.savefig('/home/nick/Documents/ic/imgs/hv/generated/hv_' + problem + '.svg', format='svg',
            dpi=1200)

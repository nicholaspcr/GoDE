...
type ExecutionSetServicesClient interface {
	...
	FetchByUser(ctx context.Context, in *UserIDs, opts ...grpc.CallOption) (ExecutionSetServices_FetchByUserClient, error)
}
...
func (c *executionSetServicesClient) FetchByUser(ctx context.Context, in *UserIDs, opts ...grpc.CallOption) (ExecutionSetServices_FetchByUserClient, error) {
...
type ExecutionSetServicesServer interface {
	...
	FetchByUser(*UserIDs, ExecutionSetServices_FetchByUserServer) error
...
func (UnimplementedExecutionSetServicesServer) FetchByUser(*UserIDs, ExecutionSetServices_FetchByUserServer) error {
